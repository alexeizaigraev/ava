...
from papa_pg import get_kabinet_pereezd_data


data = get_kabinet_pereezd_data()
...
<T3RXXXXG5S ROWNUM="1">{insert_data[3]}</T3RXXXXG5S>
<T3RXXXXG6S ROWNUM="1">{insert_data[4]}</T3RXXXXG6S>
<T3RXXXXG7S ROWNUM="1">{insert_data[5]}</T3RXXXXG7S>
<T3RXXXXG8S ROWNUM="1" xsi:nil="true"/>
<T3RXXXXG9S ROWNUM="1" xsi:nil="true"/>
<T3RXXXXG10S ROWNUM="1" xsi:nil="true"/>
<T3RXXXXG11 ROWNUM="1">{insert_data[6]}</T3RXXXXG11>
<T3RXXXXG12S ROWNUM="1">{insert_data[7]}</T3RXXXXG12S>
<T3RXXXXG13 ROWNUM="1">1406</T3RXXXXG13>
<T3RXXXXG13S ROWNUM="1">ГУ ДПС У МИКОЛАЇВСЬКІЙ ОБЛАСТІ (М. ВОЗНЕСЕНСЬК)</T3RXXXXG13S>
<R0401G1>420</R0401G1>
<R0401G1S>{insert_data[8]}</R0401G1S>
<R0402G1S>{insert_data[9]}</R0402G1S>
<R0403G1>1085</R0403G1>
<R0403G1S>{insert_data[10]}</R0403G1S>
<R0404G1S>{insert_data[11]}</R0404G1S>
<R0405G1D>{insert_data[12].replace('.', '')[:9]}</R0405G1D>
<R0408G1S>{insert_data[13]}</R0408G1S>
<R0409G1S>{insert_data[14]}</R0409G1S>
...
<R0604G1>100</R0604G1>
<R0701G1S>{insert_data[17]}</R0701G1S>
...
<HFILL>{now_date_kabinet()}</HFILL>
    ...
    ofname = KABINET_DIR + 'pereezd_' + insert_data[0] + '_' + insert_data[9] + '.xml'
    #print(ofname)
